                    ...
                    <div>
                        <div class="row" style="padding-top: 30px">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h6>AGENDA DEL DÍA</h6>

                                        <form id="FrmAgenda">
                                            <div class="row mt-3">
                                                <div class="form-group col-md-9 col-12">
                                                    <input type="text" name="txtNombreAgenda" id="txtNombreAgenda" class="form-control form-control-sm" placeholder="NOMBRE DE LA ACTIVIDAD">
                                                </div>
                                                <div class="form-group col-md-3 col-12">
                                                    <button type="submit" id="btnBuscarAgenda" class="btn btn-primary btn-xs mr-3" data-toggle="tooltip" title="Buscar Actividad"><i class="fa fa-search" aria-hidden="true"></i> BUSCAR</button>
                                                    <button type="button" id="btnAbrirNAgenda" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Agregar Actividad"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        <thead class="bg-dark">
                                                            <tr class="text-white">
                                                                <th>ACTIVIDAD</th>
                                                                <th style="width: 30%" colspan="2" class="text-medium-table">LUGAR</th>
                                                                <th style="width: 15%" colspan="2" class="text-medium-table">FECHA INICIO</th>
                                                                <th style="width: 10%" colspan="2" class="text-medium-table">ESTADO</th>                                                                
